<template>
    <button v-if="liked" @click="unlike" class="px-4 py-2 text-center text-green-500 bg-green-800 rounded-md ring-1 ring-transparent">
    ...
    <button v-else @click="like" class="px-4 py-2 text-center text-white bg-transparent rounded-md ring-1 ring-green-500 hover:text-green-500">
